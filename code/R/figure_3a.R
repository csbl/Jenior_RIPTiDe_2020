...
objflux_m9_color <- 'chartreuse'
riptide_color <- '#4347B9'
legend_text <- c('Maximal objective flux constraint',
                 'M9+glc exchange constraints',
                 'Maximal objective flux & M9+glc exchange constraints',
                 'RIPTiDe M9+glc transcriptome contextualization')
...
points(x=objflux_nmds$MDS1, y=objflux_nmds$MDS2, bg=objflux_color, pch=21, cex=2, lwd=1.5)
points(x=raw_m9_nmds$MDS1, y=raw_m9_nmds$MDS2, bg=raw_m9_color, pch=21, cex=2, lwd=1.5)
points(x=objflux_m9_nmds$MDS1, y=objflux_m9_nmds$MDS2, bg=objflux_m9_color, pch=21, cex=2, lwd=1.5)
points(x=riptide_nmds$MDS1, y=riptide_nmds$MDS2, bg=riptide_color, pch=21, cex=2, lwd=1.5)
#legend('topright', legend=legend_text, box.lwd=2, pt.lwd=1.5,
#       pt.bg=c(objflux_color,raw_m9_color,objflux_m9_color,riptide_color), pch=21, cex=1.1, pt.cex=2)
legend('bottomright', legend='iJO1366 Exchange Flux Distributions', bty='n', cex=1.2, pt.cex=0)
box(lwd=2)
dev.off()
